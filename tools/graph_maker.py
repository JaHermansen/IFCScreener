...
def get_elements_graph(file):
    ...
    fig, ax = plt.subplots()
    ax.bar(x_values, y_values, width=0.5, align="center", color="#006095", alpha=0.5)
    ax.set_title("Building Objects Count")
    ax.tick_params(color="#006095", rotation=90, labelsize="7", labelcolor="#006095")
    ax.tick_params(axis="x", rotation=90)
    ax.set_xlabel("Element Class")
    ax.set_ylabel("Count")
    ax.xaxis.label.set_color("#006095")
    ax.yaxis.label.set_color("#006095")
